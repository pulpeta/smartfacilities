...
<head>
    <meta charset="utf-8">
    <title>SF - Buildings Management</title>
    ...
    <div class="row text-center">
        <div class="col-sm">
            <h2 class="text-primary" style="color: orange">
                <span class="glyphicons glyphicons-mixed-buildings"></span>
                        ...
                        <tr class="text-primary">
                            <td>
                                <strong class="text-uppercase">
                                    <a href="<?php echo site_url("admin/plccontroller/edit_building/$building->id_building"); ?>" style="text-decoration: none">
