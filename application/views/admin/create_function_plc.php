...
<div class="container-fluid">
    ...
    <div class="row text-center">
        <div class="col-sm">
            <h2 class="text-primary"><span class="glyphicons glyphicons-exclamation-sign"></span> New PLC Function</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            <form class="form-group" name="edituser_form" method="post" action="<?php echo site_url('admin/plccontroller/create_function_plc'); ?>">
                <input class="form-control" type="text" name="function_plc" placeholder="PLC Function" required autofocus style="margin-top: 10px">
                <input class="form-control" type="text" name="description" placeholder="Optional Description" style="margin-top: 10px">
